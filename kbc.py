...
def kbc():
    ...
    while ( i <15 ):
        ...
        if isAnswerCorrect(i, int(ans) ):
            ...
            if i<6:
                print('The total reward you won is Rs. 0. Nirash na hoen, aap bohot hi achhe insaan hain!!')
            elif i<10:
                print('The total reward you won is Rs. 10,000. Yeh gaya aapke bank account mein, bas ek swipe se!')
            else:
                print('The total reward you won is Rs. 3,20,000. Yeh raha aapka cheque!')
            game_play=False
            break
